            ...
            <Element name='hero'>
                <div className='container'>
                    <div className='relative z-2 max-w-512 max-lg:max-w-388'>
                        ...
                        <h1 className='mb-6 h1 text-p4 uppercase max-lg:mb-7 max-lg:text-h2
                        max-md:mb-4 max-md:text-5xl max-md:leading-12'>
                            Amzaingly simple
                        </h1>
                        <p className='max-w-440 mb-14 body-1 max-md:mb-10'>
                            we designed Xora video editing to be easy to use, quick to learn and surprizingly powerful.
                        </p>
